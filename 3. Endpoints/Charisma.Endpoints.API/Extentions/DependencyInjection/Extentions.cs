...
public static class Extensions
{
        ...
        params string[] assemblyNamesForSearch)
    {
        ...
        EndPoints.Web.Extentions.DependencyInjection.AddZaminServicesExtensions.AddZaminUntilityServices(EndPoints.Web.Extentions.DependencyInjection.AddDataAccessExtentsions.AddZaminDataAccess(EndPoints.Web.Extentions.DependencyInjection.AddApplicationServicesExtensions.AddZaminApplicationServices(services, assemblies), assemblies)).AddCustomeDepenecies(assemblies);
        return services;
    }
